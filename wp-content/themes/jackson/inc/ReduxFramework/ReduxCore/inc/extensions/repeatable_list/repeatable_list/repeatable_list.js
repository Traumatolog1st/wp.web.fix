...
(function( $ ) {
    ...
    redux.field_objects.repeatable_list.init = function( selector ) {
        ...
        $(document).on('keyup', '.ll-repeateble-container .repeatable-content input[name $= "[title]"]', function() {
            var value = $(this).val().replace(/<(?:.|\n)*?>/gm, '') || '&nbsp;';
            var title = $(this).closest('.repeatable-row').find('.row-title .title').html( value );
        });
    };
