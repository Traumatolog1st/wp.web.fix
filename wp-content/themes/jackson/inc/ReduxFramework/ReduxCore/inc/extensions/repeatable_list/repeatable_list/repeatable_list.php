    ...
    class ReduxFramework_repeatable_list {
        ...
        public function enqueue () {
            ...
            if ($fix) {
                ...
                wp_enqueue_script( 'select2-sortable-js' );
                wp_register_script(
                    'select2-js',
        ...
        public function ll_render_fields($index = 0) {
            ...
            $title = (is_array($this->value) && isset($this->value[$index]['title']))? $this->value[$index]['title'] : '';
            ...
            echo '<div class="repeatable-row' . $row_class . '" data-index="' . $index . '">';
                if($this->field['accordion']){
                    echo '<div class="row-head">';
                        ...
                        echo '<h3 class="row-title"><span class="title">';

                            if(!empty($title)){
                                echo strip_tags($title);
                            } else {
                                if($this->field['fixed'] && is_array($this->field['items_title']) && count($this->field['items_title']) ==  $this->field['fixed'] ){
                                    echo $this->field['items_title'][$index];
                                } else {
                            ...
                            echo '</span><span class="dashicons dashicons-arrow-down row-toggle"></span>';
                        echo '</h3>';
                    echo '</div>';
        ...
        private function _renter_template($index) {
            echo '<script type="text/template" class="repeatable-row-template" style="display: none; visibility:hidden">';
            ob_start();
